...
public class MainWindowControllerReceivedInvoices {
    @FXML
    private TableView<Invoices> tableView;
    @FXML
    private TableColumn<Invoices, Integer> invoiceNumber;
    @FXML
    private TableColumn<Invoices, LocalDate> receiptDate;
    @FXML
    ...
    @FXML
    private TableColumn<Invoices, String> supplier;
    @FXML
    ...
    private void formatingCellInTableViewInitz() {
        ...
        receiptDate.setCellFactory(new Callback<TableColumn<Invoices, LocalDate>, TableCell<Invoices, LocalDate>>() {
        ...
        supplier.setCellFactory(new Callback<TableColumn<Invoices, String>, TableCell<Invoices, String>>() {
            @Override
    ...
    private void tableViewInitz() {
        ...
        receiptDate.setCellValueFactory(new PropertyValueFactory<Invoices, LocalDate>("dateOfIssueOrReceiptProp"));
        ...
        supplier.setCellValueFactory(new PropertyValueFactory<Invoices, String>("recipientOrSupplierProp"));
    ...
    public void addItemDialog(ActionEvent e) {
        ...
        fxmlLoader.setLocation(getClass().getResource("/com/zustik/erpapp/receivedInvoices/DialogAddView.fxml"));
        try {
...
//        controllerAdd.getProjectNumberField().setBackground(Background.fill(Color.RED));
    ...
    private void addNewItem (Invoices item) {
        addNewItemIntoDB(item);
        addNewItemIntoTableView(item); //poradi zavolani je dulezite, protoze pri pridani do db se k itemu prida i id, ktere je zase nutne mit, kdyz chci chci hned smazat
    }
    ...
    public void editItemDialog(ActionEvent e) {
        ...
        dialog.initOwner(mainBorderPane.getScene().getWindow()); //nastavuje parent pro dialogove okno na mainBorderpane.. pry by se to melo delat
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/com/zustik/erpapp/receivedInvoices/DialogEditView.fxml"));
        try {
            dialog.getDialogPane().setContent(fxmlLoader.load());
        } catch (IOException ee) {
            System.out.println(ee);
    ...
    protected void filterItems(ActionEvent e) {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/zustik/erpapp/receivedInvoices" +
                "/DialogFilterView.fxml"));
        try {
            dialog.getDialogPane().setContent(fxmlLoader.load());
        } catch (IOException ee) {
                ...
                switch (dataToCreateQuery.selectedChoiceInDialog) {
                    ...
                    case "Issue date" -> {
                        ...
                        if (dataToCreateQuery.equalsChosen) {
                            ...
                            dataForTableView = dataFromDB.querySelectWithParam("dateOfReceipt", //pozor nutna presna shoda s Item prop resp. MySql column
                                    dateOfIssue);
                            activeFilterInfoLabel.setVisible(true);
                            activeFilterInfoLabel.setText("Filtered by: " + dataToCreateQuery.selectedChoiceInDialog +
                            ...
                            dataForTableView = dataFromDB.querySelectWithParam("dateOfReceipt",
                    ...
                    case "Recipient" -> {
                        dataForTableView = dataFromDB.querySelectWithParam("supplierProp", //pozor nutna presna shoda s Item prop resp. MySql column
    ...
    private void selectAllItemsForTableView () {
        //2 params one observAbleList, second comparator
...
//        pro info lze taky filtrovat skrze classu filtered list, kde se posktne predikat, podminka testovaci co se me uchovat co vypustit
//        FilteredList<Invoices> filteredList = new FilteredList<>(dataFromDB.querySelectWithoutParam(),
//                new Predicate<Invoices>() {
//                    @Override
//                    public boolean test(Invoices invoices) {
//                        return invoices.getInvoiceNumberProp() > 2024005 ? true : false;
//                    }
//                });
    }
